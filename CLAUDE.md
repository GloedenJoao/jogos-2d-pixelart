...
- [x] **Os quatro projetos do plano estão jogáveis e testados** (2026-08-04). Total de 314 asserções headless: framework 16, blackjack 28, roguelike 97, platformer 80, civilização 93. Cada projeto tem `tests/run_tests.gd` (headless) e `tests/visual_capture.gd` (screenshots automáticos em `.visual_capture/`, gitignored).
